	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="/resources/index2.html" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>SN</b></span> <!-- logo for regular state and mobile devices -->
				<span class="logo-lg"><b>SINAE</b> NOTE</span>
			</a>
...
<!-- 								src="/resources/dist/img/psn.jpg" class="user-image" -->
<!-- 								alt="User Image" /> <span class="hidden-xs">Sinae Park</span> -->
<!-- 						</a> -->
<!-- 							<ul class="dropdown-menu"> -->
								<!-- User image -->
								<li class="user-header">
<!-- 								<img -->
<!-- 									src="/resources/dist/img/user3-128x128.jpg" class="img-circle" -->
<!-- 									alt="User Image" /> -->
									<p>
									</p></li>
								<!-- Menu Body -->
...
<!-- 						<img src="/resources/dist/img/psn.jpg" class="img-circle" -->
<!-- 							alt="User Image" /> -->
<!-- 					</div> -->
